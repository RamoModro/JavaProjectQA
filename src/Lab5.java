...
//        String[] myStrings = {"a", "b", "c", "d"};
        ...
        //int[] Arrayy = op.populateArray(100);
        //op.getEvenArrayToHundred(Arrayy);
        ...
        //int[] Arrayy= op.populateArray(30);
        //System.out.println(op.getAverageValueFromArray(Arrayy));

        //5. Creati o method care sa primeasca un parametru de tip array de string-uri, populat cu valori,
        ...
        //String[]arrString = {"dog", "cat", "mouse"};
        //System.out.println(op.isWordInArray(arrString,"dog"));
        ...
        //array4[3] = 345;
       // array4[4] = 5;
        //System.out.println(op.getNumberPositionInArray(array4,-7));
        ...
        //int[] arr1 = op.populateArray(10);
        //System.out.println(op.removeNumber(arr1, 5));
